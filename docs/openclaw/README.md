...
3. `OpenClaw第一阶段MCP工具清单.md`
   - 当前已落地 MCP 工具分组，以及公众号工作流、统一素材库、采集工作区等增量能力
4. `品牌运营助手Skill示例SKILL.md`
   - 当前 Skill 对网站功能路由、公众号工作流和高频任务的示例写法
5. `06-OpenClaw接口与权限落地规格_v1.md`
   - 接口、权限、审计和能力暴露边界
6. `07-OpenClaw无侵入接入与对话式体验方案_v1.md`
   - 无侵入接入、灰度、降级、回滚与体验约束
7. `05-OpenClaw详细开发方案_基于现有系统文档.md`
   - 基于当前系统结构的整体开发方案
