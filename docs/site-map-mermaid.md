...
flowchart TD
    ...
    WEC2 --> WEC25["作品卡片 + HTML 自动植图预览 + 图片点击放大 + 一键发布"]
...
flowchart TD
    ...
    AUI71 --> AUI712["品牌增长报告 / 半年营销规划 / 小红书策划 / 抖音策划 / 热点找选题 / 公众号链路 / 小红书原创二创视频 / 抖音视频阶段 / 抖音数字人口播脚本 / 设计工作台 已消费 模块+能力包+技能 绑定"]
...
flowchart TD
    ...
    M5 --> M59["公众号工作台已接配置保存、文章/配图/HTML 三段知识注入、自动植图回写、发布状态回写、数据库持久化与图片限流回退"]
