...
flowchart TD
    ...
    B --> B1["某书：营销策划方案 / 创作素材 / 每日计划 / 每周复盘 / 策略优化记录 / 作品列表"]
    B --> B2["某音/某号：营销策划方案 / 数字人 / RunningHub应用 / 创作素材 / 每日计划 / 每周复盘 / 策略优化记录 / 作品列表"]
    B --> B3["公众号：配置初始化 / 创作工作流 / 发布历史 / 创作素材 / 每日计划 / 每周复盘 / 策略优化记录 / 作品列表"]
    B --> B4["OpenClaw 五类内容详情支持留言；每周复盘与策略优化记录支持编辑"]
