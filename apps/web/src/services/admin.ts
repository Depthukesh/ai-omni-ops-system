...
export const promptTemplateSeed: PromptTemplateRecord[] = [
  ...
  },
  {
    ...
    temperature: 0.3,
    maxTokens: 2400,
    content: "根据营销规划方案、营销日历选题、产品信息和用户附加要求，生成适合小红书发布的科普类原创标题、正文与标签。",
    updatedAt: "2026-06-19T20:10:00.000Z",
  },
  {
    ...
    temperature: 0.3,
    maxTokens: 2400,
    content: "根据营销规划方案、营销日历选题、产品信息和用户附加要求，生成适合小红书发布的测评类原创标题、正文与标签。",
    updatedAt: "2026-06-19T20:10:00.000Z",
  },
  {
    ...
    temperature: 0.3,
    maxTokens: 2400,
    content: "根据营销规划方案、营销日历选题、产品信息和用户附加要求，生成适合小红书发布的避坑类原创标题、正文与标签。",
    updatedAt: "2026-06-19T20:10:00.000Z",
  },
  {
