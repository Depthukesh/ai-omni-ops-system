...
export const promptTemplateSeed: PromptTemplateRecord[] = [
  ...
  },
  {
    ...
    temperature: 0.4,
    maxTokens: 8000,
    content: "根据文章主题、营销日历、产品信息、品牌信息、主题颜色和用户要求，生成适合公众号草稿箱的 HTML 文章结构，包含标题、摘要、正文段落、小标题、引用块和结尾行动建议。",
    updatedAt: "2026-06-03T11:00:00.000Z",
  },
  {
    ...
    temperature: 0.3,
    maxTokens: 5000,
    content: "根据公众号文章主题、营销日历、产品信息、品牌信息和主题颜色，生成公众号头图、封面图和文中配图的出图提示词，并补充尺寸、版式和文字安全区要求。",
    updatedAt: "2026-06-03T11:00:00.000Z",
  },
  {
