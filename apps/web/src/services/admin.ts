...
export const promptTemplateSeed: PromptTemplateRecord[] = [
  ...
  },
  {
    ...
    temperature: 0.2,
    maxTokens: 8000,
    content: "用于公众号工作流中的 HTML 排版阶段，按通用排版风格输出最终 HTML，兼顾可读性、品牌一致性和图片植入自然度。",
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    temperature: 0.2,
    maxTokens: 8000,
    content: "用于公众号工作流中的 HTML 排版阶段，按极简排版风格输出最终 HTML，强调留白、克制和阅读节奏。",
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    temperature: 0.2,
    maxTokens: 8000,
    content: "用于公众号工作流中的 HTML 排版阶段，按空间艺术排版风格输出最终 HTML，强调结构感、视觉张力和章节节奏。",
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    temperature: 0.2,
    maxTokens: 8000,
    content: "用于公众号工作流中的 HTML 排版阶段，按通知公告风格输出最终 HTML，强调信息层级、正式感和清晰传达。",
    updatedAt: new Date().toISOString(),
  },
  {
...
export const skillPackageSkillSeed: SkillPackageSkillRecord[] = [
  ...
  },
  {
    ...
    skillName: "公众号HTML通用排版",
    skillCategory: "内容生产",
    skillStatus: "ACTIVE",
    skillProvider: "国内文生文 · DeepSeek",
    skillDefaultModel: "provider_runtime_text_deepseek::deepseek-v4-pro",
    createdAt: "2026-06-30T10:00:00.000Z",
    updatedAt: "2026-06-30T10:00:00.000Z",
  },
  {
...
export const skillAssetBindingSeed: SkillAssetBindingRecord[] = [
  ...
  {
    id: "sab_wechat_html_general",
    skillSlug: "wechat-html-general",
    promptScene: "公众号HTML通用排版",
    moduleKeys: ["wechat-workbench"],
    packageKeys: ["wechat-html-typesetting"],
    packageNames: ["公众号 HTML 排版能力包"],
  },
  {
    id: "sab_wechat_html_minimal",
    skillSlug: "wechat-html-minimal",
  ...
  {
    id: "sab_douyin_remix_short_video",
    skillSlug: "douyin-remix-short-video-studio",
    promptScene: "抖音复刻短视频-复刻分析",
    moduleKeys: ["douyin-workbench"],
    packageKeys: ["douyin-remix-short-video"],
    packageNames: ["抖音复刻短视频能力包"],
  },
  {
    id: "sab_douyin_remix_short_video_compose",
    skillSlug: "douyin-remix-short-video-compose",
...
export const apiProviderSeed: ApiProviderRecord[] = [
  {
    ...
    modelWhitelist: ["gpt-5.4", "gpt-5.4-nano"],
  ...
  },
  {
    ...
    modelWhitelist: ["stepaudio-2.5-tts"],
    apiKey: "",
    defaultModel: "stepaudio-2.5-tts",
    organization: "",
    project: "",
    timeoutMs: 180000,
    streamEnabled: false,
    ...
    extraParams: {
      ...
      baseUrls: ["https://api.stepfun.com"],
    ...
    requestCount24h: 0,
    totalCostYuan: 0,
    lastCalledAt: "2026-07-03T00:00:00.000Z",
  ...
  },
  {
    ...
    modelWhitelist: ["stepaudio-2.5-asr"],
    apiKey: "",
    defaultModel: "stepaudio-2.5-asr",
    organization: "",
    project: "",
    timeoutMs: 180000,
    streamEnabled: false,
