...
export function OriginalWorkspaceSectionContainer(props: NoteWorkspaceSectionContainerSharedProps) {
  ...
  const originalWorkspaceProps = buildOriginalWorkspaceProps({
    ...
    noteTitle: composerForms.originalNoteTitle,
    noteContent: composerForms.originalNoteContent,
    ...
    onNoteTitleChange: composerForms.setOriginalNoteTitle,
    onNoteContentChange: composerForms.setOriginalNoteContent,
