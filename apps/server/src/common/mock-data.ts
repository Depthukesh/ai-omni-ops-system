...
const opportunityInsightBrandAccountSkillContent = readPromptSourceBundle(
  "prompt_opportunity_insight_brand_account",
  "你是品牌账号分析顾问，需要同时分析小红书与抖音品牌账号的定位、内容结构、素材表达、用户互动与增长信号，输出详尽 HTML 报告。",
).content;
const opportunityInsightCompetitorAccountSkillContent = readPromptSourceBundle(
  "prompt_opportunity_insight_competitor_account",
  "你是竞品账号分析顾问，需要同时分析小红书与抖音竞品账号的打法、差异化卖点、内容节奏、爆款特征与可借鉴策略，输出详尽 HTML 报告。",
).content;
const opportunityInsightCommentSkillContent = readPromptSourceBundle(
  "prompt_opportunity_insight_comment",
  "你是评论洞察分析顾问，需要从评论数据中提炼用户痛点、需求、抱怨、购买障碍与典型场景，输出详尽 HTML 报告。",
).content;
const opportunityInsightFinalReportSkillContent = readPromptSourceBundle(
  "prompt_opportunity_insight_final_report",
  "你是品牌机会洞察顾问，需要整合品牌资料、账号分析与评论洞察，形成不少于 2000 字、带案例与数据支撑的机会洞察总报告 HTML。",
).content;
...
const xiaohongshuOriginalCopyScienceSkillContent = readPromptSourceBundle(
  "prompt_xhs_original_copy_science",
  "根据营销规划方案、营销日历选题、产品信息和用户附加要求，生成适合小红书发布的科普类原创标题、正文与标签。",
).content;
const xiaohongshuOriginalCopyReviewSkillContent = readPromptSourceBundle(
  "prompt_xhs_original_copy_review",
  "根据营销规划方案、营销日历选题、产品信息和用户附加要求，生成适合小红书发布的测评类原创标题、正文与标签。",
).content;
const xiaohongshuOriginalCopyAvoidPitfallSkillContent = readPromptSourceBundle(
...
const wechatHtmlGeneralPromptContent = readPromptSourceBundle(
  "prompt_wechat_html_general",
  "你是一位专业的公众号排版师，精通微信公众号HTML/CSS规范和视觉设计原则。",
).content;
const wechatHtmlMinimalPromptContent = readPromptSourceBundle(
  "prompt_wechat_html_minimal",
  "你是一位精通建筑美学与极简主义设计的公众号排版专家。",
).content;
const wechatHtmlSpacePromptContent = readPromptSourceBundle(
  "prompt_wechat_html_space",
  "你是一位资深的公众号视觉设计总监，拥有10年以上品牌视觉与数字媒体设计经验。",
).content;
const wechatHtmlNoticePromptContent = readPromptSourceBundle(
  "prompt_wechat_html_notice",
  "你是一位专业的政务/学院风格公众号排版助手，精通学院通知、政务公告的排版规范。",
).content;
...
const douyinRemixShortVideoSkillContent = readPromptSourceBundle(
  "prompt_douyin_remix_short_video",
  "根据短视频链接或上传视频，按每15秒一段完成复刻分析、角色卡、分镜脚本、角色图提示词和分镜图提示词输出。",
).content;
const douyinRemixShortVideoComposeSkillContent = readPromptSourceBundle(
  "prompt_douyin_remix_short_video_compose",
  "根据复刻短视频每段的分析报告、角色卡、分镜脚本和分镜图，生成可直接用于图生视频的分段提示词。",
).content;
...
export const database: MockDatabase = {
  ...
  skillConfigs: [
    ...
    {
      id: "skill_opportunity_insight_brand_account",
      name: "品牌账号分析",
      slug: "opportunity-insight-brand-account-analysis",
      category: "机会洞察",
      status: "ACTIVE",
      provider: "国内文生文 · Kimi",
      defaultModel: "kimi-k2.6",
      pointsCost: 260,
      description: "用于机会洞察第 1 步，分析小红书与抖音品牌账号的定位、内容策略与增长信号。",
      updatedAt: "2026-06-20T22:30:00.000Z",
    },
    {
      id: "skill_opportunity_insight_competitor_account",
      name: "竞品账号分析",
      slug: "opportunity-insight-competitor-account-analysis",
      category: "机会洞察",
      status: "ACTIVE",
      provider: "国内文生文 · Kimi",
      defaultModel: "kimi-k2.6",
      pointsCost: 260,
      description: "用于机会洞察第 1 步，分析小红书与抖音竞品账号的打法、内容节奏与差异化策略。",
      updatedAt: "2026-06-20T22:30:00.000Z",
    },
    {
      id: "skill_opportunity_insight_comment",
      name: "评论洞察分析",
      slug: "opportunity-insight-comment-analysis",
      category: "机会洞察",
      status: "ACTIVE",
      provider: "全球文生文",
      defaultModel: "provider_runtime_text_global::gpt-5.4",
      pointsCost: 320,
      description: "用于机会洞察第 2 步，提炼评论中的痛点、需求、负反馈与购买障碍。",
      updatedAt: "2026-06-20T22:30:00.000Z",
    },
    {
      id: "skill_opportunity_insight_final_report",
      name: "机会洞察总报告",
      slug: "opportunity-insight-final-report",
      category: "机会洞察",
      status: "ACTIVE",
      provider: "全球文生文",
      defaultModel: "provider_runtime_text_global::gpt-5.4",
      pointsCost: 360,
      description: "用于机会洞察第 3 步，整合品牌资料、账号分析与评论洞察输出总报告。",
      updatedAt: "2026-06-20T22:30:00.000Z",
    },
    {
      id: "skill_xhs_plan",
    ...
    {
      id: "skill_wechat_html_general",
      name: "公众号HTML通用排版",
      slug: "wechat-html-general",
      category: "内容生产",
      status: "ACTIVE",
      provider: "国内文生文 · DeepSeek",
      defaultModel: "provider_runtime_text_deepseek::deepseek-v4-pro",
      pointsCost: 160,
      description: "用于按通用排版风格生成公众号文章 HTML，适用于大多数公众号图文场景。",
      updatedAt: new Date().toISOString(),
    },
    {
      id: "skill_wechat_html_minimal",
      name: "公众号HTML极简排版",
      slug: "wechat-html-minimal",
      category: "内容生产",
      status: "ACTIVE",
      provider: "国内文生文 · DeepSeek",
      defaultModel: "provider_runtime_text_deepseek::deepseek-v4-pro",
      pointsCost: 160,
      description: "用于按极简主义建筑美学风格生成公众号文章 HTML，强调留白与排版克制。",
      updatedAt: new Date().toISOString(),
    },
    {
      id: "skill_wechat_html_space",
      name: "公众号HTML空间艺术排版",
      slug: "wechat-html-space",
      category: "内容生产",
      status: "ACTIVE",
      provider: "国内文生文 · DeepSeek",
      defaultModel: "provider_runtime_text_deepseek::deepseek-v4-pro",
      pointsCost: 160,
      description: "用于按空间艺术与品牌视觉总监视角生成公众号文章 HTML，强调结构感与视觉张力。",
      updatedAt: new Date().toISOString(),
    },
    {
      id: "skill_wechat_html_notice",
      name: "公众号HTML通知类排版",
      slug: "wechat-html-notice",
      category: "内容生产",
      status: "ACTIVE",
      provider: "国内文生文 · DeepSeek",
      defaultModel: "provider_runtime_text_deepseek::deepseek-v4-pro",
      pointsCost: 160,
      description: "用于按政务/学院通知公告规范生成公众号文章 HTML，强调层级与正式感。",
      updatedAt: new Date().toISOString(),
    },
    {
    ...
    },
    {
      ...
      defaultModel: "provider_runtime_text_global::gpt-5.4",
      pointsCost: 180,
      description: "用于生成活动页、品牌页和 landing page 的 HTML 原型。",
    ...
    },
    {
      ...
      defaultModel: "provider_runtime_text_global::gpt-5.4",
      pointsCost: 180,
      description: "用于生成经营分析、运营监控和 KPI 数据看板页面。",
      updatedAt: "2026-06-03T23:30:00.000Z",
    },
    {
      ...
      defaultModel: "provider_runtime_text_global::gpt-5.4",
      pointsCost: 180,
      description: "用于生成功能卖点、价格方案和 CTA 完整的营销落地页。",
    ...
    },
    {
      ...
      defaultModel: "provider_runtime_text_global::gpt-5.4",
      pointsCost: 160,
      description: "用于生成新品发布、活动预热和促销邮件页面结构。",
      updatedAt: "2026-06-04T00:20:00.000Z",
    },
    {
      ...
      defaultModel: "provider_runtime_text_global::gpt-5.4",
      pointsCost: 160,
      description: "用于生成产品说明页、能力说明页和知识页。",
      updatedAt: "2026-06-04T00:20:00.000Z",
    },
    {
      ...
      defaultModel: "provider_runtime_text_global::gpt-5.4",
      pointsCost: 160,
      description: "用于生成长图文博客页、专题页和内容发布页。",
      updatedAt: "2026-06-04T00:20:00.000Z",
    },
    {
    ...
    },
    {
      ...
      defaultModel: "provider_runtime_text_global::gpt-5.4",
      pointsCost: 180,
      description: "用于生成任务化、积分化、闯关式互动页面。",
      updatedAt: "2026-06-04T00:20:00.000Z",
    },
    {
      ...
      defaultModel: "provider_runtime_image_generation_right_codes::gpt-image-2",
      pointsCost: 200,
      description: "用于生成品牌社媒轮播图、方版卡片和传播视觉。",
      updatedAt: "2026-06-03T23:30:00.000Z",
    },
    {
    ...
    },
    {
      ...
      defaultModel: "provider_runtime_image_generation_right_codes::gpt-image-2",
      pointsCost: 220,
      description: "用于生成动效海报首帧、动态标题视觉和可延展的动画关键帧。",
      updatedAt: "2026-06-04T00:20:00.000Z",
    },
    {
    ...
    },
    {
      ...
      defaultModel: "provider_runtime_text_global::gpt-5.4",
      pointsCost: 220,
      description: "用于生成品牌提案、Pitch Deck 和汇报结构。",
      updatedAt: "2026-06-03T23:30:00.000Z",
    },
    {
      ...
      defaultModel: "provider_runtime_text_global::gpt-5.4",
      pointsCost: 180,
      description: "用于生成周报、阶段复盘和里程碑更新 deck。",
      updatedAt: "2026-06-04T00:20:00.000Z",
    },
    {
      ...
      defaultModel: "provider_runtime_text_global::gpt-5.4",
      pointsCost: 180,
      description: "用于生成极简汇报、产品概览和单主题演示稿。",
      updatedAt: "2026-06-04T00:20:00.000Z",
    },
    {
      ...
      defaultModel: "provider_runtime_text_global::gpt-5.4",
      pointsCost: 200,
      description: "用于生成视频故事板、镜头脚本和口播建议。",
      updatedAt: "2026-06-03T23:30:00.000Z",
    },
    {
      ...
      defaultModel: "provider_runtime_text_global::gpt-5.4",
      pointsCost: 200,
      description: "用于生成动态标题、节奏镜头和转场脚本。",
      updatedAt: "2026-06-04T00:20:00.000Z",
    },
  ],
  promptTemplates: [
    ...
    },
    {
      ...
      temperature: 0.3,
      maxTokens: 2400,
      content: xiaohongshuOriginalCopyScienceSkillContent,
      updatedAt: "2026-06-19T20:10:00.000Z",
    },
    {
      ...
      temperature: 0.3,
      maxTokens: 2400,
      content: xiaohongshuOriginalCopyReviewSkillContent,
      updatedAt: "2026-06-19T20:10:00.000Z",
    },
    {
      ...
      temperature: 0.3,
      maxTokens: 2400,
      content: xiaohongshuOriginalCopyAvoidPitfallSkillContent,
      updatedAt: "2026-06-19T20:10:00.000Z",
    },
    {
    ...
    },
    {
      ...
      version: "v1.0",
      status: "ACTIVE",
      modelName: "provider_runtime_text_global::gpt-5.4",
      temperature: 0.4,
      maxTokens: 8000,
    ...
    },
    {
      ...
      temperature: 0.2,
      maxTokens: 8000,
      content: wechatHtmlGeneralPromptContent,
      updatedAt: new Date().toISOString(),
    },
    {
      id: "prompt_wechat_html_minimal",
      name: "公众号HTML极简排版提示词",
      scene: "公众号HTML极简排版",
      version: "v1",
      status: "ACTIVE",
      ...
      temperature: 0.2,
      maxTokens: 8000,
      content: wechatHtmlMinimalPromptContent,
      updatedAt: new Date().toISOString(),
    },
    {
      id: "prompt_wechat_html_space",
      name: "公众号HTML空间艺术排版提示词",
      scene: "公众号HTML空间艺术排版",
      version: "v1",
      status: "ACTIVE",
      modelName: "provider_runtime_text_deepseek::deepseek-v4-pro",
      temperature: 0.2,
      maxTokens: 8000,
      content: wechatHtmlSpacePromptContent,
      updatedAt: new Date().toISOString(),
    },
    {
      id: "prompt_wechat_html_notice",
      name: "公众号HTML通知类排版提示词",
      scene: "公众号HTML通知类排版",
      version: "v1",
      status: "ACTIVE",
      modelName: "provider_runtime_text_deepseek::deepseek-v4-pro",
      temperature: 0.2,
      maxTokens: 8000,
      content: wechatHtmlNoticePromptContent,
      updatedAt: new Date().toISOString(),
    },
    {
    ...
    },
    {
      ...
      temperature: 0.2,
      maxTokens: 12000,
      content: douyinRemixShortVideoSkillContent,
      updatedAt: "2026-06-19T21:30:00.000Z",
    },
    {
      ...
      temperature: 0.2,
      maxTokens: 6000,
      content: douyinRemixShortVideoComposeSkillContent,
      updatedAt: "2026-06-19T21:30:00.000Z",
    },
    {
    ...
    {
      id: "prompt_opportunity_insight_brand_account",
      name: "品牌账号分析提示词",
      scene: "机会洞察-品牌账号分析",
      version: "v1.0",
      status: "ACTIVE",
      ...
      temperature: 0.4,
      maxTokens: 12000,
      content: opportunityInsightBrandAccountSkillContent,
      updatedAt: "2026-06-20T22:30:00.000Z",
    },
    {
      id: "prompt_opportunity_insight_competitor_account",
      name: "竞品账号分析提示词",
      scene: "机会洞察-竞品账号分析",
      version: "v1.0",
      status: "ACTIVE",
      ...
      temperature: 0.4,
      maxTokens: 12000,
      content: opportunityInsightCompetitorAccountSkillContent,
      updatedAt: "2026-06-20T22:30:00.000Z",
    },
    {
      id: "prompt_opportunity_insight_comment",
      name: "评论洞察分析提示词",
      scene: "机会洞察-评论洞察分析",
      version: "v1.0",
      status: "ACTIVE",
      ...
      temperature: 0.4,
      maxTokens: 12000,
      content: opportunityInsightCommentSkillContent,
      updatedAt: "2026-06-20T22:30:00.000Z",
    },
    {
      id: "prompt_opportunity_insight_final_report",
      name: "机会洞察总报告提示词",
      scene: "机会洞察-机会洞察总报告",
      version: "v1.0",
      status: "ACTIVE",
      ...
      temperature: 0.4,
      maxTokens: 14000,
      content: opportunityInsightFinalReportSkillContent,
      updatedAt: "2026-06-20T22:30:00.000Z",
    },
  ],
  knowledgeBases: [
  ...
  skillPackages: [
    ...
    {
      id: "sp_opportunity_insight",
      packageKey: "opportunity-insight",
      packageName: "机会洞察能力包",
      description: "用于品牌账号分析、竞品账号分析、评论洞察分析与机会洞察总报告生成。",
      status: "ACTIVE",
      scope: "PLATFORM",
      moduleKeys: ["brand-growth-workbench"],
      workflowStepKeys: [
        "opportunity-insight-brand-account-step",
        "opportunity-insight-competitor-account-step",
        "opportunity-insight-comment-step",
        "opportunity-insight-final-report-step",
      ],
      tags: ["insight", "opportunity", "analysis", "brand-growth"],
      currentVersionId: "spv_opportunity_insight_v1",
      defaultKnowledgeSpaceIds: ["kb_brand_docs", "kb_competitor_cases"],
      defaultProviderPolicyIds: ["brand-text-provider-policy"],
      sortOrder: 25,
      remarks: "品牌增长工作台机会洞察能力包。",
    ...
    {
      id: "sp_douyin_video_production",
      packageKey: "douyin-video-production",
      packageName: "抖音视频生产能力包",
      description: "抖音故事板视频与直出成片能力包。",
      status: "ACTIVE",
      scope: "PLATFORM",
      moduleKeys: ["douyin-workbench"],
      workflowStepKeys: ["douyin-video-generate-step"],
      tags: ["douyin", "video"],
      currentVersionId: "spv_douyin_video_production_v1",
      defaultKnowledgeSpaceIds: [],
      defaultProviderPolicyIds: ["brand-video-provider-policy"],
      sortOrder: 50,
      remarks: "抖音工作台默认 AI 生视频能力包。",
      createdAt: "2026-06-19T21:20:00.000Z",
      updatedAt: "2026-06-19T21:20:00.000Z",
    },
    {
      id: "sp_douyin_remix_short_video",
      packageKey: "douyin-remix-short-video",
      packageName: "抖音复刻短视频能力包",
      description: "抖音复刻分析与拼接成片的双阶段能力包。",
      status: "ACTIVE",
      scope: "PLATFORM",
      moduleKeys: ["douyin-workbench"],
      workflowStepKeys: ["douyin-remix-short-video-step"],
      tags: ["douyin", "video", "remix"],
      currentVersionId: "spv_douyin_remix_short_video_v1",
      defaultKnowledgeSpaceIds: [],
      defaultProviderPolicyIds: ["brand-video-provider-policy"],
      sortOrder: 60,
      remarks: "抖音工作台默认复刻短视频能力包。",
    ...
    {
      id: "sp_wechat_html_typesetting",
      packageKey: "wechat-html-typesetting",
      packageName: "公众号 HTML 排版能力包",
      description: "负责公众号 HTML 的 4 种排版风格输出，包括通用、极简、空间艺术和通知类排版。",
      status: "ACTIVE",
      scope: "PLATFORM",
      moduleKeys: ["wechat-workbench"],
      workflowStepKeys: ["wechat-html-render-step"],
      tags: ["wechat", "html", "layout"],
      currentVersionId: "spv_wechat_html_typesetting_v1",
      defaultKnowledgeSpaceIds: ["kb_feishu_ops"],
      defaultProviderPolicyIds: ["brand-wechat-provider-policy"],
      sortOrder: 70,
      remarks: "公众号 HTML 4 风格排版能力包。",
  ...
  skillPackageVersions: [
    ...
    {
      id: "spv_opportunity_insight_v1",
      packageId: "sp_opportunity_insight",
      packageKey: "opportunity-insight",
      versionNumber: "v1",
      changeLog: "初始化机会洞察能力包版本，注册 4 个独立技能。",
      sourceMode: "CURRENT_STATE",
      isActive: true,
      snapshotJson: {
        promptCount: 4,
    ...
    {
      id: "spv_douyin_video_production_v1",
      packageId: "sp_douyin_video_production",
      packageKey: "douyin-video-production",
      versionNumber: "v1",
      changeLog: "初始化抖音视频生产能力包版本，承接故事板与直出视频技能。",
      sourceMode: "CURRENT_STATE",
      isActive: true,
      snapshotJson: {
        promptCount: 1,
    ...
    {
      id: "spv_douyin_remix_short_video_v1",
      packageId: "sp_douyin_remix_short_video",
      packageKey: "douyin-remix-short-video",
      versionNumber: "v1",
      changeLog: "初始化抖音复刻短视频能力包版本，纳入复刻分析与拼接成片双阶段技能。",
      sourceMode: "CURRENT_STATE",
      isActive: true,
      snapshotJson: {
        promptCount: 2,
    ...
    {
      id: "spv_wechat_html_typesetting_v1",
      packageId: "sp_wechat_html_typesetting",
      packageKey: "wechat-html-typesetting",
      versionNumber: "v1",
      changeLog: "初始化公众号 HTML 排版能力包版本，纳入 4 种排版风格技能。",
      sourceMode: "CURRENT_STATE",
      isActive: true,
      snapshotJson: {
        promptCount: 4,
  ...
  moduleDefinitions: [
    {
      ...
      taskTypes: ["BRAND_GROWTH_REPORT_AI", "HALF_YEAR_PLAN_AI", "OPPORTUNITY_INSIGHT_STEP_ONE"],
      mediaTypes: [],
      workflowTypes: ["brand-growth-workflow"],
      publishTargets: [],
      defaultSkillPackages: ["brand-growth-analysis", "enterprise-annual-plan", "opportunity-insight"],
    ...
    },
    {
      ...
      defaultSkillPackages: ["tongcheng-brand-douyin-planning", "douyin-video-production", "douyin-remix-short-video"],
    ...
    },
    {
      ...
      defaultSkillPackages: ["wechat-article-generator", "wechat-image-designer", "wechat-html-typesetting"],
  ...
  skillPackageModules: [
    ...
    },
    {
      ...
      sortOrder: 30,
      enabled: true,
      remarks: "公众号工作流必需的 HTML 4 风格排版能力。",
      createdAt: "2026-06-30T10:00:00.000Z",
      updatedAt: "2026-06-30T10:00:00.000Z",
    },
    {
    ...
    {
      id: "spm_opportunity_insight_default",
      packageId: "sp_opportunity_insight",
      packageKey: "opportunity-insight",
      packageName: "机会洞察能力包",
      moduleKey: "brand-growth-workbench",
    ...
    {
      id: "spm_douyin_video_production_default",
      packageId: "sp_douyin_video_production",
      packageKey: "douyin-video-production",
      packageName: "抖音视频生产能力包",
      moduleKey: "douyin-workbench",
      ...
      sortOrder: 20,
      enabled: true,
      remarks: "抖音工作台默认视频生产能力包。",
      createdAt: "2026-06-19T21:20:00.000Z",
      updatedAt: "2026-06-19T21:20:00.000Z",
    },
    {
      id: "spm_douyin_remix_short_video_default",
      packageId: "sp_douyin_remix_short_video",
      packageKey: "douyin-remix-short-video",
      packageName: "抖音复刻短视频能力包",
      moduleKey: "douyin-workbench",
  ...
  skillPackageSkills: [
    ...
    {
      id: "sps_opportunity_brand_account_default",
      packageId: "sp_opportunity_insight",
      packageKey: "opportunity-insight",
      packageName: "机会洞察能力包",
      skillId: "skill_opportunity_insight_brand_account",
      skillSlug: "opportunity-insight-brand-account-analysis",
      bindingType: "DEFAULT",
      isDefault: true,
      sortOrder: 10,
      enabled: true,
      remarks: "机会洞察第 1 步品牌账号分析技能。",
      createdAt: "2026-06-20T22:30:00.000Z",
      updatedAt: "2026-06-20T22:30:00.000Z",
    },
    {
      id: "sps_opportunity_competitor_account_default",
      packageId: "sp_opportunity_insight",
      packageKey: "opportunity-insight",
      packageName: "机会洞察能力包",
      skillId: "skill_opportunity_insight_competitor_account",
      skillSlug: "opportunity-insight-competitor-account-analysis",
      bindingType: "DEFAULT",
      isDefault: true,
      sortOrder: 20,
      enabled: true,
      remarks: "机会洞察第 1 步竞品账号分析技能。",
      createdAt: "2026-06-20T22:30:00.000Z",
      updatedAt: "2026-06-20T22:30:00.000Z",
    },
    {
      id: "sps_opportunity_comment_default",
      packageId: "sp_opportunity_insight",
      packageKey: "opportunity-insight",
      packageName: "机会洞察能力包",
      skillId: "skill_opportunity_insight_comment",
      skillSlug: "opportunity-insight-comment-analysis",
      bindingType: "DEFAULT",
      isDefault: true,
      sortOrder: 30,
      enabled: true,
      remarks: "机会洞察第 2 步评论洞察分析技能。",
      createdAt: "2026-06-20T22:30:00.000Z",
      updatedAt: "2026-06-20T22:30:00.000Z",
    },
    {
      id: "sps_opportunity_final_report_default",
      packageId: "sp_opportunity_insight",
      packageKey: "opportunity-insight",
      packageName: "机会洞察能力包",
      skillId: "skill_opportunity_insight_final_report",
      skillSlug: "opportunity-insight-final-report",
      bindingType: "DEFAULT",
      isDefault: true,
      sortOrder: 40,
      enabled: true,
      remarks: "机会洞察第 3 步总报告技能。",
      createdAt: "2026-06-20T22:30:00.000Z",
      updatedAt: "2026-06-20T22:30:00.000Z",
    },
    {
    ...
    {
      id: "sps_wechat_html_general_default",
      packageId: "sp_wechat_html_typesetting",
      packageKey: "wechat-html-typesetting",
      packageName: "公众号 HTML 排版能力包",
      skillId: "skill_wechat_html_general",
      skillSlug: "wechat-html-general",
      bindingType: "SYSTEM_REQUIRED",
      isDefault: true,
      sortOrder: 10,
      enabled: true,
      remarks: "公众号 HTML 通用排版技能。",
      createdAt: "2026-06-30T10:00:00.000Z",
      updatedAt: "2026-06-30T10:00:00.000Z",
    },
    {
      id: "sps_wechat_html_minimal_default",
      packageId: "sp_wechat_html_typesetting",
      packageKey: "wechat-html-typesetting",
      packageName: "公众号 HTML 排版能力包",
      skillId: "skill_wechat_html_minimal",
      skillSlug: "wechat-html-minimal",
      bindingType: "SYSTEM_REQUIRED",
      isDefault: true,
      sortOrder: 20,
      enabled: true,
      remarks: "公众号 HTML 极简排版技能。",
      createdAt: "2026-06-30T10:00:00.000Z",
      updatedAt: "2026-06-30T10:00:00.000Z",
    },
    {
      id: "sps_wechat_html_space_default",
      packageId: "sp_wechat_html_typesetting",
      packageKey: "wechat-html-typesetting",
      packageName: "公众号 HTML 排版能力包",
      skillId: "skill_wechat_html_space",
      skillSlug: "wechat-html-space",
      bindingType: "SYSTEM_REQUIRED",
      isDefault: true,
      sortOrder: 30,
      enabled: true,
      remarks: "公众号 HTML 空间艺术排版技能。",
      createdAt: "2026-06-30T10:00:00.000Z",
      updatedAt: "2026-06-30T10:00:00.000Z",
    },
    {
      id: "sps_wechat_html_notice_default",
      packageId: "sp_wechat_html_typesetting",
      packageKey: "wechat-html-typesetting",
      packageName: "公众号 HTML 排版能力包",
      skillId: "skill_wechat_html_notice",
      skillSlug: "wechat-html-notice",
      bindingType: "SYSTEM_REQUIRED",
      isDefault: true,
      sortOrder: 40,
      enabled: true,
      remarks: "公众号 HTML 通知类排版技能。",
      createdAt: "2026-06-30T10:00:00.000Z",
      updatedAt: "2026-06-30T10:00:00.000Z",
    },
    {
  ...
  skillPackageKnowledgeSpaces: [
    ...
    {
      id: "spks_opportunity_brand_docs_default",
      packageId: "sp_opportunity_insight",
      packageKey: "opportunity-insight",
      packageName: "机会洞察能力包",
      knowledgeBaseId: "kb_brand_docs",
      ...
      isRequired: true,
      enabled: true,
      remarks: "品牌资料库作为机会洞察默认知识空间。",
      createdAt: "2026-06-20T22:30:00.000Z",
      updatedAt: "2026-06-20T22:30:00.000Z",
    },
    {
      id: "spks_opportunity_competitor_cases_optional",
      packageId: "sp_opportunity_insight",
      packageKey: "opportunity-insight",
      packageName: "机会洞察能力包",
      knowledgeBaseId: "kb_competitor_cases",
