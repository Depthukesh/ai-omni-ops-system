...
export const database: MockDatabase = {
  ...
  skillPackages: [
    ...
    },
    {
      ...
      description: "抖音直出视频、复刻短视频与拼接成片的统一视频生产能力包。",
      status: "ACTIVE",
      scope: "PLATFORM",
      moduleKeys: ["douyin-workbench"],
      workflowStepKeys: ["douyin-video-generate-step", "douyin-remix-short-video-step"],
  ...
  skillPackageVersions: [
    ...
    },
    {
      ...
      packageKey: "douyin-video-production",
      versionNumber: "v1",
      changeLog: "初始化抖音视频生产能力包版本，纳入直出视频与复刻短视频双阶段技能。",
      sourceMode: "CURRENT_STATE",
      isActive: true,
      snapshotJson: {
        promptCount: 3,
  ...
  moduleDefinitions: [
    ...
    },
    {
      ...
      defaultSkillPackages: ["tongcheng-brand-douyin-planning", "douyin-video-production"],
