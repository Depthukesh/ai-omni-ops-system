...
import { CollectorsController, DouyinCollectorsController } from "./collectors.controller";
...
@Module({
  ...
  controllers: [CollectorsController, DouyinCollectorsController, DailyHotspotsController],
