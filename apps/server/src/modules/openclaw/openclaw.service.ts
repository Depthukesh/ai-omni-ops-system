...
const OPENCLAW_WEBSITE_FUNCTION_CATALOG: OpenClawWebsiteFunctionCatalogItem[] = [
  ...
  },
  {
    ...
    summary: "适合识别 OpenClaw 安装中心、MCP 安装、Skill ZIP/Git 安装，以及 OpenChatCut 统一网关、A/B/C 配置示例与 curl 测试命令；当前复制和可视化安装动作仍以网站页面承接为主。",
    pageUrl: "/personal-center/openclaw",
    pageLabel: "打开 OpenClaw 安装中心",
    riskLevel: "low",
    intentKeywords: ["openclaw安装", "mcp安装", "skill安装", "安装中心", "安装令牌", "workbuddy", "cursor", "claude desktop", "openchatcut", "统一网关", "gateway", "curl测试", "a类", "b类", "c类"],
    requiredInputKeys: [],
    requiredInputs: [],
    recommendedQuestions: ["帮我看看 OpenClaw 安装中心现在有什么可以交付的内容", "告诉我 OpenClaw 和 Skill 现在该怎么安装", "告诉我 OpenChatCut 统一网关和 A/B/C 配置现在该怎么填"],
    mcpTools: [
