...
const OPENCLAW_COMMENT_RESOURCE_TYPES = ["creative_material", "daily_plan", "lobster_diary", "strategy_optimization", "marketing_plan", "video_work", "tencent_ad_lead"] as const;
